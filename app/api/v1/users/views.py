...
from app.api.v1.users import blacklist
from app.utils.views_helpers import check_for_existing_user
...
class UserSignup(Resource):
    def post(self):
        ...
        user_to_sign_up = {
            "id": UserModel.total_users_created,
            "isadmin": False,
        ...
        if existing_user_error:
            ...
            if (
                ...
                UserModel.sign_up(user_to_sign_up)
                return {
                    "status": 201,
                    "data": [
                        {
                            "user": user_to_sign_up,
    ...
    def post(self):
        ...
        if user_to_log_in:
            if check_password_hash(
                user_to_log_in["password"], user_credentials["password"]
            ):
                access_token = create_access_token(
                    user_to_log_in["username"],
